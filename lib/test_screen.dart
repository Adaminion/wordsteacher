...
class _TestScreenState extends State<TestScreen> {
 ...
 void checkAnswer() {
  ...
  // Store the original correct answer for display
        ...
        actions: [
          Center(
            child: Padding(
              ...
              child: Text(
            'Question ${currentIndex + 1}/${widget.entries.length}${currentIndex > 0 
...
TextField(
 controller: answerController,
  ...
  decoration: InputDecoration(
    ...
    fillColor: isCorrect == true ? Colors.green.shade50 : Colors.green.shade50, // Color based on correctness
  ),
  onChanged: (_) => setState(() {}), // Rebuild UI when typing to update button text
  onSubmitted: (_) {
    if (isCorrect == null) {
      checkAnswer();
    } else {
...
// Action button - changes text based on state
SizedBox(
    ...
    onPressed: () {
      if (isCorrect == null) {
        if (answerController.text.isEmpty) {
          // "No idea" case - auto-fill with "I don't know" or similar
